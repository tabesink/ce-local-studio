...
- `CONTEXT.md`
- `README.md` and `AGENTS.md` in Git `HEAD`
- `specs/02-architecture/{system-context,component-boundaries,data-ownership,integration-flows}.md`
- `context_engine/{app,db,models}.py`
- `context_engine/services/*`
- `frontend/src/*`
