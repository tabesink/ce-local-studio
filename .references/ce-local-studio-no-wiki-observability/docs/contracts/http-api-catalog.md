...
| Request ID | server emits `X-Request-ID`; same value appears in errors |
| Error | `{ "error": { "code": "closed_code", "message": "Safe text.", "requestId": "req_...", "fields": {} } }` |
| IDs/time | opaque case-sensitive refs; RFC 3339 UTC timestamps |
