...
Commit a machine-readable parity manifest beside the baselines. Each entry records the Local Studio source commit and exact anchor, Context Engine route/state/persona, fixture revision, viewport, zoom, theme, screenshot path, masks, threshold, and approved divergence identifier. The canonical Local Studio visual snapshot is commit `07be5be7ce69bea0c3118744ab90d148b010fce0`; a moving reference `HEAD` is forbidden.
...
{
  "schemaVersion": "1.0",
  "sourceCommit": "07be5be7ce69bea0c3118744ab90d148b010fce0",
  "entries": [{
