...
- **Authority:** Root `AGENTS.md`; `DESIGN.md`; `docs/frontend/AGENTS.md`; `docs/frontend/ui-parity-spec.md`; `docs/frontend/component-contracts.md`; `docs/frontend/design-token-contract.md`; `docs/frontend/source-adaptation-map.md`; `docs/master-build-plan.md` P9-01 + Frontend-factory evidence staging; brownfield parent `docs/plans/2026-07-22-001-docs-brownfield-phase-contract-alignment-plan.md` (KTD12 / U5); this Product Contract.
