...
| P10 | Deployable application stack | IN_PROGRESS | P8-P9 | runnable Compose stack, explicit migrations/bootstrap, worker lifecycle, smoke path, and operator runbook pass — P10-01..P10-03 DONE; P10-04 MinIO object store and P10-05 provider packaging open |
...
| P5-04 | DONE | P3-03,P5-03,P6-01,P10-03 | replace the placeholder/synthetic runtime path with one real private `app/vendor/lightrag` runtime per Knowledge Domain; keep PostgreSQL authoritative; inject the immutable server-resolved embedding profile and private provider configuration; preserve the schema-v2 handoff and existing index/retrieval ports; prove real submit→ready→mapped Evidence→delete/absence, uncertain-outcome recovery, restart, and parallel cross-domain isolation; do not add a JSON domain registry, Redis/RQ, browser-visible runtime details, or vendor-owned source authority — plan `docs/plans/2026-07-28-006-feat-p5-04-real-lightrag-runtime-plan.md`; evidence `docs/_scratch/p5-04-lightrag-real-runtime-evidence.md` |
...
| P9-07 | NOT_STARTED | P9-02,P9-03,P9-04,P4-05,P11-02 | contracted browser workflows: conversation rename/delete (M-08), ordered composer-ref discovery/attach (M-09), Settings `If-Match` concurrency (A-01), and domain/source operation-history recovery UX (A-03/A-07/A-09/A-10) — plan `docs/plans/2026-07-28-010-feat-p9-07-contracted-browser-workflows-plan.md` |
...
| P10-05 | NOT_STARTED | P4-03,P7-03,P10-03 | production parser/model-provider packaging and deployment-profile proof for Docling/Reducto and OpenAI/Bedrock/Ollama; CI stays no-network fixture altitude; credential-gated staging smoke before claiming a provider production-supported — plan `docs/plans/2026-07-28-012-feat-p10-05-provider-packaging-plan.md` |
...
| P12-04 | NOT_STARTED | P5-04,P10-04,P12-01 | backup/restore, image rollback, failed-worker recovery and incident drills, including MinIO object version/key consistency and rebuild/reconciliation of private per-domain LightRAG derivatives — plan `docs/plans/2026-07-28-005-feat-p12-04-backup-restore-drills-plan.md` |
...
| P12-06 | NOT_STARTED | P0,P5-04,P10-04,P10-05,P12-02 | immutable artifact manifest with the pinned vendored LightRAG runtime image, MinIO/provider/runtime locks, schema and contract versions, SBOM and provenance — plan `docs/plans/2026-07-28-014-feat-p12-06-immutable-artifact-manifest-plan.md` |
| P12-07 | NOT_STARTED | P5-04,P9-07,P10-04,P10-05,P12-02,P12-03 | accessibility, browser E2E, CSRF product path, two-user cache isolation, real LightRAG capacity/isolation, provider/runtime-failure, deterministic fixture materialization, and minimum operational-safety evidence — plan `docs/plans/2026-07-28-015-feat-p12-07-browser-e2e-capacity-plan.md` |
