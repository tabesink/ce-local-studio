...
| P9 | Thin Next.js frontend | DONE | P1-P8 | login/chat/documents/settings and the reserved graph state use only versioned APIs — P9-01..P9-06 DONE; P12 owns deployed-ingress / visual-matrix residuals |
