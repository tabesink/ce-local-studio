...
| P12-05 | DONE | P5-04,P7-06,P9,P12-02 | deployed-ingress incremental domain-RAG SSE, reconnect/replay, graceful shutdown and stream-drain proof through the real private LightRAG runtime — plan `docs/plans/2026-07-28-013-feat-p12-05-deployed-ingress-sse-drain-plan.md`; inventory/evidence `docs/_scratch/p12-05-deployed-ingress-{inventory,evidence}.md`; live TLS Compose AE1–AE4 green (three-file + LightRAG + OpenAI); residuals: PDF byte-range / Playwright / adversarial deletion → P12-07; hard provider-I/O abort / HA → P12-08 |
