...
| FE-10 Settings | runtime-setting DTOs, A-01/A-02/A-13 | member/admin sections, credential replacement, safe conflicts and frozen-operation inputs | stored secret/provider payload appears in DTO |
